...
def read_encoded_data():
    ...
    X_train = np.loadtxt("/Users/zbz/code/vscodemac_python/hetero_sshe_logistic_regression/data/splice/distrubuted/encoded/X_encoded_train37.txt", delimiter=',') #, dtype = float)
    X_test = np.loadtxt("/Users/zbz/code/vscodemac_python/hetero_sshe_logistic_regression/data/splice/distrubuted/encoded/X_encoded_test37.txt", delimiter=',') #, dtype = float)
    # X = normalize(X,'l2')
...
### 完成sparse之前的, 后面可以跑一下有sparse的分布式的和没有spasrse的计算一下时间差, 加速还是很明显的!
