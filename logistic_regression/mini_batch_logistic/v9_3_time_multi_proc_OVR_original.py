...
class LogisticRegression:
    ...
    #     """ Train Model """
    #     self.fit_model_secure_distributed_input(self, X_trainA, X_trainB, Y_train, instances_count, indice_littleside)
    ...
    def OVRClassifier(self, X_train1, X_train2, X_test1, X_test2, Y_train, Y_test):
        ...
        for i in range(len(label_lst)):
            ...
            # print(Y_train_new)
            self.fit_model_secure_distributed_input(X_train1, X_train2, Y_train_new, X_train1.shape[0],
                                                                    indice_littleside)
...
if __name__ == "__main__":
    ...
    LogisticRegressionModel = LogisticRegression(weight_vector = weight_vector, batch_size = 40, 
                    max_iter = 300, alpha = 0.001, eps = 1e-6, ratio = 0.7, penalty = None, lambda_para = 1, data_tag = None)
                    # splice 分布式 0.9062068965517242
    # LogisticRegressionModel = LogisticRegression(weight_vector = weight_vector, batch_size = 20, 
